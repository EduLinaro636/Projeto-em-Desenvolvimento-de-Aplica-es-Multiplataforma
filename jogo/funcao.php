...
function primeiraPergunta(){
    ...
    <html>
        ...
        <body>
                ...
                <div class='container'>
                    <form action = '.' align='center' method = 'post' class='confimacao'>
                            <button type='submit' name='tipoPersonagem' value='jogador'>Jogador</button>
                            <br>
                            <button type='submit' name='tipoPersonagem' value='estádio'>Estádio</button>
                            <br>
                            <button type='submit' name='tipoPersonagem' value='time'>Time</button>
                    </form>
                </div>
        </body>
    </html>
            ...
            <div class='container'>
                ...
                <div class='container'>
                    ...
                    <form method = 'post' align='center' class='confimacao'>
                        ...
                        <br>
                        <button type='submit' name='resposta' value='nao_sei'>Não sei</button>
